...
test_that(".designOligos and .isValid work", {
    ...
    # gcProportion <- .isValid(oligos$gcContent, c(0.5, 0.55))
    #  expect_true(is.double(gcProportion))
    # gcLocical <- .isValid(oligos$gcContent[[1]][1], c(0.5, 0.55))
    #  expect_true(is.list(gcLogical))
})
