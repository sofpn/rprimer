...
The package is available as a Shiny application, which is loaded by typing `runRprimerApp()` in the R console. It is also available online at [sofpn.shinyapps.io/rprimer](https;//sofpn.shinyapps.io/rprimer). 
