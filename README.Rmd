...
rprimer seeks to address the challenge of amplifying sequence variable viruses by providing tools for visualization of sequence conservation and generating degenerate DNA oligos from a multiple sequence alignment.
