...
The next step is to design oligos. You can either use the default settings as below, or adjust the constraints (see the package vignette or `?rprimer::oligos` for more information).
