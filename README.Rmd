...
The purpose of rprimer is to design (RT)-(q/dd)PCR assays for highly variable
target sequences from multiple sequence alignments. 
...
mask positions with high gap frequency. For this part, I use previously 
existing functionality from the Biostrings-package. 
