...
`designAssays()` finds pairs of forward and reverse primers and combines them with probes, if probes are present in the input dataset. You can either use the default settings as below, or adjust the design constraints if required (see the package vignette or `?designAssays` for more information).
