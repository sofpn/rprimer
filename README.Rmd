...
These objects are extensions of the `DataFrame` class from S4Vectors, and thus behave similar to traditional data frames. 
...
`getConsensusProfile()` takes a `Biostrings::DNAMultipleAlignment` object as input and returns all the information needed for the subsequent design process. Masked positions will be excluded. 
