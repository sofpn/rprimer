...
The next step is to design oligos. You can either use the default settings as below, or adjust the design constraints in several different ways (see the package vignette or `?oligos` for more information).
