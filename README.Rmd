...
for detection of hepatitis E virus. 
...
Masked positions are removed. ***OBS*** 
...
nucleotides with a frequency higher than the `iupacThreshold` will be 
included in the IUPAC consensus base. 
