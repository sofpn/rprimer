...
A simplified homo-dimer check is performed for all primer candidates. A primer will be excluded from consideration if the last four (or more) bases at the 3´ end are complementary to some part of at least one sequence variant of the same primer. 
