...
Before proceeding to wet lab evaluation, it is recommended to evaluate the final primer and probe candidates for 1) more details on the potential to form primer dimers and hairpin structures, and 2), the potential to (not) cross react with non-targets. 
