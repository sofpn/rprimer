...
rprimer provides tools for analyzing sequence conservation and designing degenerate  oligos (primers and probes) from a multiple DNA sequence alignment. The package is developed primarily for sequence variable viruses, but it should be equally useful for other organisms with high sequence variability.  
...
The workflow can be run through a Shiny app. It is loaded by:
