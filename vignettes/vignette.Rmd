...
rprimer seeks to address the challenge of amplifying sequence variable viruses by providing tools for visualization of sequence conservation and generating degenerate DNA oligos from a multiple sequence alignment. In this document, I demonstrate how to use the package by designing broadly-reactive RT-(q/d)PCR primers, probes and assays for detection of hepatitis E virus (HEV), which is a sequence variable RNA-virus and a common foodborne pathogen.  
