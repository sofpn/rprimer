...
It is also possible to export oligos and assays in fasta-format. To do this, the object of interest must first be cocered to a `Biostrings::DNAStringSet` object, as follows:
...
The sequences can now be saved in fasta format as follows: 
