...
It is often valuable to investigate how the generated oligos match with their target sequences. `checkMatch()` can be used for this purpose. The function is a wrapper to `Biostrings::vcountPDict()` [@PagesBios] and has two arguments: 
...
```{r}
## Check the first three candidates in the oligoSelection datasert
