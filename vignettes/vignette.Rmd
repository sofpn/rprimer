...
The package contains five functions, which are interconnected in a workflow:
...
The workflow described in this vignette can also be run through a Shiny app. It is loaded by:
