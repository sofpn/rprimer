...
All valid oligos are scored based on their average identity, coverage, and GC-content. The score can range from 0 to 9, where 0 is considered best. You can find more information about the scoring system in the manual (`?oligos`).
...
The best possible average score is 0 and the worst possible score is 9 (see [Step 2](#Step2) for more information).
