...
* `threeEndDimerWindowPrimer`: , defaults to `NULL` **XXXXXXXXXXXXXXXXXXXXXXXXXXXXX**
...
Before proceeding to wet lab evaluation, it is highly recommended to evaluate the final primer and probe candidates for 1) more details on the potential to form primer dimers and hairpin structures (e.g. hybridization properties using delta G calculations), and 2), the potential to (not) cross react with non-targets. 
