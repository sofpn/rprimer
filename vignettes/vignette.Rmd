...
The output gives information of the proportion of oligos that matches perfectly as well as with 1, 2, 3 or 4 or more mismatches to the intended oligo binding region in the input alignment (i.e., on target match). It also reports the proportion of oligos that matches with no more than 4 mismatches to *all other regions* in the input alignment (off target match). However, note that the output does not say anything about the type, position or severity of the mismatches.
