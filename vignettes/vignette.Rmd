...
### Check how candidate oligos matches to the input target alignment 

- list args 
- target alignment must be supplied , exactly the same as used for design
- can be slow , used the ones with best score 
- simple check, does not say anything about position of mm 

```{r}
myOligosMatch <- checkMatch(oligoSelection, target = myAlignment)
```
