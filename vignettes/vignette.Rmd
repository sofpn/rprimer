...
In this case, identity refers to the mean identity of the 5' consensus part of the oligo and the coverage refers to the mean coverage of the 3' degenerate part of the oligo. Values of 1 indicate complete conservation of the target region in the alignment. 

It is possible to subset the oligo dataset in many different ways. I select to look at oligos with an average 3' coverage higher than 0.9:
