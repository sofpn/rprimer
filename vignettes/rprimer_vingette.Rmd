...
my_assays <- get_assays(
  ...
  length = 65:75, 
  max_tm_difference = 2) %>% 
  add_probes(., my_probes, tm_difference = c(-2, 5))  
...
Prepare a .txt-file with an alignment of the sequences of interest (in fasta-format), and import it using `read_fasta_alignment()`. In this example, I use an alignment with 100 HEV sequences that I have collected from GenBank. 
