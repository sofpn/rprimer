...
description: >
Start here if you want to learn how to use rprimer. 
vignette: >
...
## RT-PCR assay design 
There are a multitude of factors to take into account when designing assays for PCR/RT-PCR/RT-qPCR, for instance:  
...
The rprimer package provides functions to faliclitat this process, and is especially designed to work for highly variable target sequences. The aim is to provide efficient workflows and well documented results
