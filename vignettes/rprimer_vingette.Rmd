---
title: "Introduction to rprimer"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Introduction to rprimer}
...
## RT-PCR assay design 
There are a multitude of factors to take into account when designing assays for PCR/RT-PCR/RT-qPCR/RT-ddPCR, for instance:  
...
The rprimer package provides functions to facilitate this process, and is especially designed to work for highly variable target sequences. The aim is to provide efficient workflows and well documented results

In this document, I demonstrate how to use rprimer by designing a real-time RT-PCR assay for detection of hepatitis E virus (HEV), which is a highly variable RNA-virus and a common food-borne pathogen.

**describe more: tm, perfect matches**

## The whole workflow

The following pipeline designs PCR-assays for you. 
```{r}
# Import alignment 
...
Again, the output can be visualised with `rp_plot()`. Below, vertical bars represent the value at each position. The black bars in the two uppermost figures represent values of 1 and 0, respectively (i.e. positions with complete conservation). The horizontal lines represent c7entered running averages. 
