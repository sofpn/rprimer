...
```{r}
my_sequence_properties <- sequence_properties(my_sequence_profile)
...
```{r}
rp_plot(my_sequence_properties[300:500, ]) # Select position 300-500
```
...
Here is the entire workflow (to copy-paste):
