...
```
<br>
Amplicon sequence (consensus sequence): `r consensus`,
Amplicon GC-content (consensus sequence): `r round(gc_content(consensus, 2)*100` %.
Presence of G repeats in amplicon (more than 3 consecutive G:s in consensus sequence): `r find_g_repeats(consensus)` 
G repeats can prevent strand dissociation and thus reduce amplification efficiency (ref: S. Bustin, J. Hugget 2017).
<br><br>
