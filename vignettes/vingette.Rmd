...
I mask all positions with at least 50 % gaps. However, masking positions with high gap frequency should we done with caution, since it may lead to that oligos are placed in positions were some sequences have inserts **(should I add an  avoid mask option in get oligos?)**
