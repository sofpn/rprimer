...
# example_rprimer_sequence_profile <- sequence_profile(example_rprimer_alignment)

# example_rprimer_sequence_properties <- sequence_properties(
#  example_rprimer_sequence_profile, iupac_threshold = 0.1
# )
