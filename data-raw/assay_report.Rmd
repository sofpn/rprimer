...
```
<br><br>
The assay was designed from an alignment of `r "blah"` sequences. The length of the alignment/region of interest was `r "blah"` nucleotides. The report was generated `r Sys.Date()`.
<br><br>
```{r}
