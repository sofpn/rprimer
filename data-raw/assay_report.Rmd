...
### Target information
<br>
Amplicon sequence (consensus sequence): `r paste(sequence_properties$majority[assay_report[[1]]$general$begin:assay_report[[1]]$general$end], collapse = "")`,
Amplicon GC-content (consensus sequence): `r round(gc_content(paste(sequence_properties$majority[assay_report[[1]]$general$begin:assay_report[[1]]$general$end], collapse = "")), 2)*100` %.
Presence of G-repeats in amplicon (more than 3 consecutive G:s): **ADD FUNCTION** 
G repeats in the amplicon sequence can prevent strand dissociation and thus reduce amplification efficiency (ref: S. Bustin, J. Hugget 2017).
<br><br>
