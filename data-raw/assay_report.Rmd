...
<br><br>
`r rownames(assay_selection$match_matrix[[1]][which(rowSums(assay_selection$match_matrix[[1]]) == ncol(assay_selection$match_matrix[[1]])), ])`.
Sequences with at least one mismatch: 
<br><br>
`r rownames(assay_selection$match_matrix[[1]][which(rowSums(assay_selection$match_matrix[[1]]) != ncol(assay_selection$match_matrix[[1]])), ])`.
